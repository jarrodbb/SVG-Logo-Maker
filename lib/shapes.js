...
class Circle extends Shape {
  ...
  render(shapeColor, textColor, text) {
    if (shapeColor === "") {
      throw new Error("Must include inputs for the shape color");
    }
    if (textColor === "") {
      throw new Error("Must include inputs for the text color");
    }
    if (text === "") {
      throw new Error("Must include inputs for the text");
    }
